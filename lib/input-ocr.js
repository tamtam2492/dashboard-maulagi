(function (root, factory) {
  ...
  function createInputOcrController(options) {
    ...
    const setTransferDatetime = typeof options.setTransferDatetime === 'function' ? options.setTransferDatetime : () => {};
    ...
    async function runOCR(base64DataUrl, runOptions = {}) {
      ...
      try {
        ...
        const transferDatetime = ocrResult.transfer_datetime || null;
        if (transferDatetime) {
          filledState.transferDatetime = transferDatetime;
        }
