...
const buildOcrWorkerPackage = require('./build-ocr-worker-package');

const projectRoot = path.resolve(__dirname, '..', '..');
const workerDir = path.join(projectRoot, 'tmp', 'aws-ocr-worker-package');
const zipPath = path.join(projectRoot, 'tmp', 'aws-ocr-worker-package.zip');
